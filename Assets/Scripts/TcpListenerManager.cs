...
public class TcpListenerManager : MonoBehaviour
{
    ...
    //     {
    //         //---Using received data---
    //         receivedData = Int32.Parse(dataReceived);  //<-- assigning receivedPos value from Python
    ...
    void SendAndReceiveData()
{
    ...
    if (!string.IsNullOrEmpty(dataReceived))
    {
        ...
        // if (dataReceived == "6" || receivedData == "6")  // Assuming "jump" or 6 is the message for jumping
        //     {
        //         unityChanControl.TriggerJump();  // Call the method to trigger jump in UnityChanControlScriptWithRgidBody
        //     }
